...
[链接1](https://www.cordc.net/auth/register?code=elWE)  

[备用链接2](https://www.cordc.xyz)
...
## 充值
> **初次使用者建议先买10元的试试，如不合适可以减少损失。若使用的是[链接1](https://www.cordc.net/auth/register?code=elWE)则会赠送1元，所以只需充值9元即可。**
>
> **界面如下：**
